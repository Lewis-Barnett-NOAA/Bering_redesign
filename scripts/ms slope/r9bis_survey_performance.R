...
p<-
  ...
  #save plot
  ragg::agg_png(paste0('igures/slope/true_CV_warmcold.png'), width = 9, height = 6, units = "in", res = 300)
...
p <- 
  ...
  ragg::agg_png(paste0('figures/slope/RBIAS_cv.png'), width = 10, height = 6, units = "in", res = 300)
  #ragg::agg_png(paste0('./figures/ms_hist_indices_cv_box_EBSNBS_suppl.png'), width = 13, height = 8, units = "in", res = 300)
  p
  dev.off()
