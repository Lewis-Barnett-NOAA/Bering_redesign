...
save(cvs,file = 'output/optimization/ss_ms.RData')
load(file = 'output/optimization/ss_ms.RData')
...
load('output/survey_performance/estimated_index_hist.RData') #ind2
...
#true cv
load('output/survey_performance/true_ind_hist.RData') #ind2
